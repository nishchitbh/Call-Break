...
cards = ['KS', '9S', 'JH', '7H', '5H', 'KC', 'QC', '9C', '6C', 'KD', '7D', '4D']
played = []
history = []
print(spades_checker(played))
a = input('What do you want to see?play/bid: ')
if a.lower() == 'play':
    logic(played, cards, history)
elif a.lower() == 'bid':
    print(bid_calculator(cards))
stop = time.time()
print('time = ', stop - start)
# {'timeBudget': 364, 'playerId': 'P0', 'playerIds': ['P0', 'Bot-1', 'Bot-2', 'Bot-3'], 'cards': ['KH', '6H', '5H', '4H'], 'played': ['8H', 'TH'], 'history': [[3, ['5C', '1C', '4C', 'TC'], 0], [0, ['1D', '3D', '2D', '4D'], 0], [0, ['KD', '6D', '5D', '8D'], 0], [0, ['3C', '8C', 'KC', '2C'], 2], [2, ['7S', '9S', 'TS', '1S'], 1], [1, ['2S', '3S', '5S', 'KS'], 0], [0, ['QS', '4S', '6S', '8S'], 0], [0, ['9D', 'JD', 'QD', '7D'], 2], [2, ['TD', '7C', '3H', '6C'], 2]], 'context': {'round': 1, 'players': {'P0': {'totalPoints': 0, 'bid': 5, 'won': 5}, 'Bot-1': {'totalPoints': 0, 'bid': 3, 'won': 1}, 'Bot-2': {'totalPoints': 0, 'bid': 2, 'won': 3}, 'Bot-3': {'totalPoints': 0, 'bid': 1, 'won': 0}}}}
